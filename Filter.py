...
print (Fore.YELLOW + "")
time.sleep(1.7)
print("                      RUBIKA= On -- @D_gorjipoor")
print ("                telegram @D_gorjipoor")
print ("insta @D_gorjipoor")
print(f"{blue} ")
time.sleep(1.0)
print ("!!")
time.sleep(0.7)
...
print ("~iegn")
time.sleep(0.5)
print ("cood info server")
time.sleep(0.1)
print ("script server cood")
time.sleep(0.5)
print ("server1:y//d/f")
time.sleep(1.0)
print ("server2:f//d/")
...
print ("script server")
time.sleep(0.5)
print ("script connect server rubika.ir/rubika.com/ file os server")
time.sleep(1.0)
print ("cood filter group 90% apn cood proxy-server")
time.sleep(0.5)
print ("cood filter account rubika 87% apn cood filter proxy-port:8000")
time.sleep(1.0)
print ("cood filter chaneel rubika 78% apn proxy file port:auth")
time.sleep(0.5)
print ("")
print (" ")
print ("")
...
|||||Telegram: T.me/D_gorjipoor ||||
|>|>|>|>|>|>|>|>|>|>|>|>|>|>|>|>|>|>|
____________ id:D_gorjipoor___________
""")
print(f"{red} ")
...
print("love hack")
print("")
print(" im maxtor making D_gorjipoor")
print("")
print("ip rubika.ir = 5.106.10.226 ")
print("")
print(" Chanel Telegram=>> @D_gorjipoor -")
print (Fore.WHITE + " ")
time.sleep(3.0)
print (" Dani Filtering-hacker All maxtor")
time.sleep(3.0)
print (f"{red} ")
time.sleep(1)
...
git clone https://github.com/danixpxp/filterrubika
